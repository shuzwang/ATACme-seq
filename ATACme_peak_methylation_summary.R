# The function is to summarize the methylation levels and coverage for each ATACme peak.
# The input files are the peak file and methylation calling file. Also, you can select the order of the output file.
